...
--------------------------
  -You should import the project into eclipse as maven.
  -You should change the chrome driver path whic is in SetUp() function      under UserAction.java
  ...
  -To run the project, you need to run the UserAction.java class as run      junit.
